...
public class Share_Cat_Profile_Public {
	Logger logger = LogManager.getLogger(Share_Cat_Profile_Public.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("Share_Cat_Profile_Public.properties");
