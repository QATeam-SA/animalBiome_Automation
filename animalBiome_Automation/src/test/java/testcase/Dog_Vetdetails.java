...
public class Dog_Vetdetails {
	...
	private void AddVetdetails(JavascriptExecutor js) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement vetbtn = driver.findElement(By.xpath(prop.getProperty("G_AddVeterinarian")));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", vetbtn);
		Thread.sleep(1000);
		vetbtn.click();
		Thread.sleep(4000);
