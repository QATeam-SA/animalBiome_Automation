...
public class Others_Share_pet_Profile_Private {
	Logger logger = LogManager.getLogger(Others_Share_pet_Profile_Private.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("Others_Share_pet_Profile_Private.properties");
	...
	public void SharingThePrivateProfileForOthers() throws InterruptedException
	{
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath(prop.getProperty("petsearch"))).sendKeys("sheep");
		Thread.sleep(4000);
