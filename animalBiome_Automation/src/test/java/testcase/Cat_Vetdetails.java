...
public class Cat_Vetdetails {
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("Cat_Vetdetails.properties");
	...
	public void AddingACatWithoutImageAndWithVetDetails() throws InterruptedException
	{
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(prop.getProperty("j_weight"))).sendKeys("19");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(prop.getProperty("j_postalcode"))).sendKeys("12345");
		Thread.sleep(1000);
	  ...
	  public void addpet_pethealth() throws InterruptedException
	  {
		...
		public void addpet_Vetdetails() throws InterruptedException 
	  {
		  ...
		  Thread.sleep(2000);
		  driver.findElement(By.xpath(prop.getProperty("j_ClinicName"))).sendKeys("J's vet clinic");
		  Thread.sleep(2000);
		  driver.findElement(By.xpath(prop.getProperty("j_Veternarian_Name"))).sendKeys("Aster");
		  Thread.sleep(2000);
		  jse.executeScript("window.scrollBy(0,300)");
		  Thread.sleep(3000);
		  ...
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(prop.getProperty("j_Clinic_Postalcode"))).sendKeys("87456");
		  Thread.sleep(2000);
		  driver.findElement(By.xpath(prop.getProperty("j_VetMail"))).sendKeys("qavets@gmail.com");
		  Thread.sleep(1000);
