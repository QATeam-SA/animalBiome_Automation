...
public class VetOthers_share_patient_profile_public {
	Logger logger = LogManager.getLogger(VetOthers_share_patient_profile_public.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("VetOthers_share_patient_profile_public.properties");
	
	@Test(priority=14,enabled=true)
	public void SharingThePublicProfileForOthers() throws InterruptedException {
		Thread.sleep(10000);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		driver.findElement(By.xpath(prop.getProperty("patientsearch"))).sendKeys("Dwarf");
		Thread.sleep(4000);
		...
		Thread.sleep(4000); 
		driver.close(); 
		logger.info("public others patient profile is shared successfully");
