...
public class VetUser_Others_ReportSearchbar {
	Logger logger = LogManager.getLogger(VetUser_Others_ReportSearchbar.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("VetUser_Others_ReportSearchbar.properties");
