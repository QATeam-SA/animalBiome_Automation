...
public class User_Others_Edit_Petdetails {
	...
	public void EditingTheOthersPetDetails() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(prop.getProperty("j_Antibiotics_descp"))).sendKeys("Antibiotics");
		Thread.sleep(3000);
		driver.findElement(By.xpath(prop.getProperty("j_Supplements"))).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(prop.getProperty("j_supplements_desc"))).sendKeys("supplements");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		WebElement ele=driver.findElement(By.xpath(prop.getProperty("j_Frequency")));
