...
public class VetOthers_List_Grid_Views {
	Logger logger = LogManager.getLogger(VetOthers_List_Grid_Views.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("VetOthers_List_Grid_Views.properties");
