...
public class VetOthers_View_All_Reports {
	Logger logger = LogManager.getLogger(VetOthers_View_All_Reports.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("VetOthers_View_All_Reports.properties");
	...
	public void ClickingOnViewAndAllReportsForothers() throws InterruptedException {
		...
		driver.findElement(By.xpath(prop.getProperty("petsearch"))).sendKeys("Alpaca");
		Thread.sleep(4000);
		...
		jse.executeScript("window.scrollBy(0,-300)");
		Thread.sleep(4000);
		logger.info("clicked on the view button from patient portal home of the patient");
		...
		jse.executeScript("window.scrollBy(0,-300)");
		Thread.sleep(4000);
		driver.findElement(By.xpath(prop.getProperty("j_allrpt_search"))).sendKeys("AFG94J");
		Thread.sleep(3000);
		...
		logger.info("clicked on the allreports button from view patient details page");
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath(prop.getProperty("j_petportalhome"))).click();
		logger.info("clicked on the report button from patient portal home of the patient");
	}
}
