...
public class VetOthers_Share_Patient_Profile_Private {
	Logger logger = LogManager.getLogger(VetOthers_Share_Patient_Profile_Private.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("VetOthers_Share_Patient_Profile_Private.properties");
	
	
	@Test(priority=14,enabled=true)
	public void SharingThePrivateProfileForOthers() throws InterruptedException
	{
		Thread.sleep(4000);
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath(prop.getProperty("patientsearch"))).sendKeys("sheep");
		Thread.sleep(4000);
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath(prop.getProperty("j_sharepatientprofile"))).click();
		Thread.sleep(4000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(prop.getProperty("j_patientportalhome"))).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath(prop.getProperty("j_myacnt_userprofile"))).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath(prop.getProperty("j_userprofile"))).click();
